 ...
 * Use the [FragmentFiltradoFacturas.newInstance] factory method to
...
class FragmentFiltradoFacturas : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentFiltradoFacturas.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentFiltradoFacturas().apply {
